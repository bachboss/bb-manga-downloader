...
public class Heuristic {
    ...
    private static final Pattern[] DEFAULT_CHAPTER_LIST = {
        Pattern.compile(PATTERN_CHAPTER_REGEX_ENGLISH + PATTERN_SPACE + PATTERN_NUMBER_REGEX),
        Pattern.compile(PATTERN_CHAPTER_REGEX_VNESE + PATTERN_SPACE + PATTERN_NUMBER_REGEX),
        Pattern.compile(PATTERN_SPACE + PATTERN_NUMBER_REGEX + PATTERN_CHAPTER_REGEX_CHINESE)
    };
